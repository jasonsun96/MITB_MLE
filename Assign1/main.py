"""
Assignment 1 — Data Pipeline orchestrator.

Builds a Medallion-architecture datamart from 4 raw CSV sources.

Run with:
    python main.py

Produces datamart/{bronze,silver,gold}/... — see README for full structure.
"""
...
# Raw source CSVs. Source name is also used in the bronze/silver filenames.
SOURCES = {
